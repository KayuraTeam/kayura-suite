            ...
            $rootScope.$on('$includeContentLoaded', function (event) {
	            if (!$rootScope.editorInitialized) {
	                ...
	                jQuery(window).resize(function () {
	                    ...
	                    if (propSectionHeight === undefined || propSectionHeight === null
	                    ...
	                    var totalAvailable = jQuery(window).height() - jQuery("#editor-header").height();
	                    canvas.height(totalAvailable - propSectionHeight + 10);
