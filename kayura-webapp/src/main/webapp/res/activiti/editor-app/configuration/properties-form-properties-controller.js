...
var KisBpmFormPropertiesPopupCtrl = ['$scope', '$q', '$translate', '$timeout', function($scope, $q, $translate, $timeout) {
    ...
    $scope.propertyTypeChanged = function() {
        ...
        } else if ($scope.selectedProperties[0].type === 'datetime') {
            $scope.selectedProperties[0].datePattern = 'yyyy-MM-dd HH:mm:ss';
            
        } else if ($scope.selectedProperties[0].type === 'time') {
            $scope.selectedProperties[0].datePattern = 'HH:mm:ss';
